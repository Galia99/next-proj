...
public class ShoppingBagPage extends AbstractPage{
	...
	private static final By2 bagCounterSpan = new By2("'Bag counter'", By.xpath("//a[@class='dk_toggle dk_label']"));
	private static final By2 shoppingBagTitle = new By2("'shopping bag title'", By.xpath("//h1[contains(text(),'SHOPPING BAG')]"));
